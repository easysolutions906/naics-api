...
/**
 * Generates the complete NAICS 2022 code list as JSON.
 * Run: node scripts/generate-naics.js
 */
...
const OUT = join(__dirname, '..', 'src', 'data', 'naics.json');

// Complete NAICS 2022 codes: [code, title]
// Source: US Census Bureau 2022 NAICS
const raw = `11|Agriculture, Forestry, Fishing and Hunting
111|Crop Production
...
31525|Men's and Boys' Cut and Sew Apparel Manufacturing
315250|Men's and Boys' Cut and Sew Apparel Manufacturing
...
334513|Instruments and Related Products Manufacturing for Measuring, Displaying, Indicating, Recording, Transmitting, and Controlling Industrial Process Variables
...
335139|Other Lighting Equipment Manufacturing
...
44131|Automotive Parts and Accessories Retailers
...
44413|Hardware Retailers
444130|Hardware Retailers
44419|Other Building Material Dealers
444190|Other Building Material Dealers
4442|Lawn and Garden Equipment and Supplies Retailers
44421|Outdoor Power Equipment Retailers
444210|Outdoor Power Equipment Retailers
44422|Nursery, Garden Center, and Farm Supply Retailers
444220|Nursery, Garden Center, and Farm Supply Retailers
...
44531|Beer, Wine, and Liquor Retailers
445310|Beer, Wine, and Liquor Retailers
...
45521|Warehouse Clubs and Supercenters
455211|Warehouse Clubs and Supercenters
45529|Other General Merchandise Retailers
...
4591|Sporting Goods and Musical Instrument Retailers
...
4853|Taxi and Ridesharing Services
...
51611|Internet Publishing and Broadcasting and Web Search Portals
516110|Internet Publishing and Broadcasting and Web Search Portals
5162|Streaming Services and Social Networks
51621|Streaming Services and Social Networks
516210|Streaming Services and Social Networks
517|Telecommunications
5171|Wired and Wireless Telecommunications Carriers
51711|Wired and Wireless Telecommunications Carriers
...
52311|Investment Banking and Securities Intermediation
523110|Investment Banking and Securities Intermediation
52312|Securities Brokerage
523120|Securities Brokerage
52313|Commodity Contracts Intermediation
523130|Commodity Contracts Intermediation
...
52392|Portfolio Management and Investment Advice
...
62111|Offices of Physicians (except Mental Health Specialists)
621111|Offices of Physicians (except Mental Health Specialists)
62112|Offices of Physicians, Mental Health Specialists
...
const codes = raw.split('\n').map((line) => {
  ...
  const level = (() => {
    const len = code.replace('-', '').length;
    const levels = { 2: 'sector', 3: 'subsector', 4: 'industry_group', 5: 'naics_industry', 6: 'national_industry' };
    return levels[len] || 'sector';
  })();
  return { code, title, level };
});

writeFileSync(OUT, JSON.stringify(codes, null, 2) + '\n');
console.log(`Wrote ${codes.length} NAICS codes to ${OUT}`);
